...
import com.loki.testapp.MapsActivity;
import com.loki.testapp.R;
        ...
        this.locationHelper.getLastLocation(this).observe(this, new Observer<Location>() {
            ...
            public void onChanged(Location location) {
                if (location != null){
                    ...
                    binding.tvLocationAddress.setText(lastLocation.toString()+"<>"+lastLocation.getLatitude()+"<>"+lastLocation.getLongitude());
        ...
        this.locationCallback = new LocationCallback() {
            ...
            public void onLocationResult(@NonNull LocationResult locationResult) {
                for(Location loc : locationResult.getLocations()){
                    ...
                    binding.tvLocationAddress.setText(lastLocation.toString()+"<>"+lastLocation.getLatitude()+"<>"+lastLocation.getLongitude());
                    Log.w("Update Lat long",lastLocation.getLatitude()+"<>"+lastLocation.getLongitude());
                    weatherAPIIntegration();
